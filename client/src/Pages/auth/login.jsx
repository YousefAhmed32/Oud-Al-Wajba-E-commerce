...
<div className="min-h-screen luxury-gradient flex flex-col justify-start items-center p-6 pt-10">
...
<div className="w-full max-w-6xl mx-auto">
      ...
      {/* logo for mobile */}
     <div className="block lg:hidden  mb-10  pb-10">
      ...
      <Card className="bg-luxury-navy/30 backdrop-blur-sm border-luxury-gold/20 shadow-[0_0_50px_rgba(210,176,101,0.2)]">
          ...
          <div className="w-full max-w-md mx-auto order-1 lg:order-2 hidden lg:block">
